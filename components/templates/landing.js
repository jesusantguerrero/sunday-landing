...
import PriceSection from "../molecules/pricing"
        ...
        <main>
            ...
            <div class="px-4 mx-auto text-center max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="inline-flex rounded-md shadow">
                    <a href="https://daily.icservice-soft.com/register" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-700">
                    Sign Up Today
                    </a>
                </div>
